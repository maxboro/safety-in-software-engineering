...
Safety cases are commonly treated as **one or more documents containing claims, arguments, and evidence** about meeting safety requirements, and they must be updated when safety-significant changes occur. ([Международная организация авиации][2])
...
Safety cases degrade fastest when they are treated as a one-time document. Practical safety guidance treats the safety case as something you maintain as the system changes—especially for **safety-significant changes**. ([Международная организация авиации][2])
