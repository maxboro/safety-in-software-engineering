...
Security is commonly defined around **confidentiality, integrity, and availability** (CIA). ([ЦРБК NIST][3])
...
* Treat “integrity of commands and sensor data” and “availability of safety functions” as both security and safety concerns. ([ЦРБК NIST][3])
