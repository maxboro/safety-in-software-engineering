...
* **Assumption-aware**
  ...
  * Safety cases and safety arguments explicitly capture **assumptions and context** and link them to evidence; requirements should do the same. ([Федеральное авиационное управление][2])
  * Pattern:
