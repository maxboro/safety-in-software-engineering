...
* **Exposure (E):** how often the system and environment are in a situation where the hazard could matter. In automotive functional safety, ASIL determination considers **severity, probability of exposure, and controllability**. ([Инфоцентр Файлы][4])
* **Controllability (C):** how likely a human (or external actor) can avoid the harm once the hazardous situation occurs. This is part of ISO 26262 hazard analysis and risk assessment logic (HARA). ([Инфоцентр Файлы][4])
